...
def _stitch_texture(size: int) -> Image.Image:
    image = Image.new("RGBA", (size, size), (255, 255, 255, 0))
    draw = ImageDraw.Draw(image, "RGBA")
    for x in range(-size, size * 2, 18):
        draw.line((x, 0, x + 10, 10), fill=(235, 235, 225, 210), width=2)
        draw.line((x + 1, 1, x + 11, 11), fill=(115, 115, 105, 70), width=1)
